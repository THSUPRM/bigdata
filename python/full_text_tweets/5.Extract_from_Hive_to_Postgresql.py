...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        start_datetime = datetime(2018, 3, 6)
        end_datetime = datetime(2018, 3, 29)
        for single_datetime in datetimerange(start_datetime, end_datetime):
            ...
            update(fromtime.isoformat().replace("T", " ") + " +0000", totime.isoformat().replace("T", " ") + " +0000")
    ...
    # Run once with parametrized dates
        ...
        fromtime = datetime(fromtimetup[0], fromtimetup[1], fromtimetup[2], fromtimetup[3], 0, 0).isoformat().replace("T", " ") + " +0000"
        totime = datetime(totimetup[0], totimetup[1], totimetup[2], totimetup[3], 0, 0).isoformat().replace("T", " ") + " +0000"
