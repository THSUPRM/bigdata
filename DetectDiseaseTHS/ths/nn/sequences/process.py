...
class ProcessTweetsGloveOnePassBestModelsMulticlass:
    ...
    def process(self, json_filename, h5_filename):
        ...
        for combination in params:
            ...
            NN.compile(loss="categorical_crossentropy", metrics=['accuracy', precision, recall, f1, fprate], **params_compile)
            ...
            NN.fit(X_train, Y_train, epochs=l[2], callbacks=[history], class_weight=class_weight_dictionary, **params_fit)
